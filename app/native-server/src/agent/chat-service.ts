 ...
 *
 * This service handles session-level scheduling without concern for specific CLI/SDK implementation details.
 * Dependency inversion via the Engine interface allows replacing or adding engines without modifying the HTTP route layer.
 */
