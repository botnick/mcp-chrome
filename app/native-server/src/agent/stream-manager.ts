 ...
 *
 * This implementation is based on the StreamManager from other/cweb, adapted for Fastify/Node HTTP.
 * It writes SSE data directly via ServerResponse, avoiding extra Web Streams dependencies in Node.
 */
