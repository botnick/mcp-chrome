 ...
 * Automatically clears the buffer when navigating to a new domain to avoid mixing logs from different sites.
 */
...
class ConsoleBuffer {
  ...
  /**
   * Check if the specified tab is currently capturing in buffer mode
   */
  ...
  /**
   * Ensure buffer capture is started for the specified tab
   */
