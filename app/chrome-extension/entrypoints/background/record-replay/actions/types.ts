...
export interface TimeoutPolicy {
  ms: Milliseconds;
  /** 'attempt' = per-attempt timeout, 'action' = total action timeout */
...
export interface RetryPolicy {
  /** Number of retries (excluding initial attempt) */
  retries: number;
  /** Retry interval */
...
/**
 * ActionParamsByType uses interface declaration
 * allowing external modules to extend Action types via declaration merging (OCP compliant)
 */
