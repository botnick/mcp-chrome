 ...
 * @description Defines run events and states for Record-Replay V3
 */
 ...
 * @description seq must be atomically assigned by the storage layer (via RunRecordV3.nextSeq).
