/**
 * @fileoverview V2/V3 Flow bidirectional conversion utility
 * @description Bridges Builder V2 Flow types with V3 RPC FlowV3 types
 *
 * Design notes:
 * - Builder store currently uses V2 types (type, version, steps)
 * - RPC layer uses V3 types (kind, schemaVersion, entryNodeId)
 * - This module provides UI-layer type conversion, wrapping low-level converters
 */
