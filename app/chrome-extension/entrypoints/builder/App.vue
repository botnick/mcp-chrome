<template>
  ...
  <div class="builder-page rr-theme" :data-theme="theme">
    <div v-if="fallbackNotice" class="notice-top">
      <span>Fallback applied: promoted {{ fallbackNotice.type }} priority</span>
    ...
    <div class="main">
      ...
      <div class="bottom-toolbar">
        <button class="toolbar-btn" @click="store.undo" title="Undo (Cmd/Ctrl+Z)">
          <svg
            width="16"
            height="16"
            viewBox="0 0 24 24"
        ...
        <button class="toolbar-btn" @click="store.redo" title="Redo (Cmd/Ctrl+Shift+Z)">
          <svg
            width="16"
            height="16"
            viewBox="0 0 24 24"
