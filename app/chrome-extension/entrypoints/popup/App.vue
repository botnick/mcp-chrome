<template>
  ...
  >
    ...
    <!-- Sidebar handles workflow management; editor opens in a separate window -->
...
// AgentChat theme - loaded from preload, consistent with sidepanel
...
// Run history and overrides are viewed in the sidebar page
const startRecording = async () => {
  // TODO: Record & replay feature is in development, intercepting for now
    ...
    try {
      ...
      if (result && result.success === false) {
        ...
        if (failed && failed.stepId) {
          // Open editor window and focus the failed node
...
function openWorkflowSidepanel() {
  // TODO: Workflow feature is in development, intercepting for now
...
async function toggleElementMarker() {
  try {
    ...
    // Send message to background to start element annotation
