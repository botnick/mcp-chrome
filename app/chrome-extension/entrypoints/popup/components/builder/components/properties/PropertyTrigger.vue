<template>
  ...
  <div class="form-section">
    ...
    <div class="form-group checkbox-group">
      ...
      >
      <label class="checkbox-label"
        ><input type="checkbox" v-model="cfg.modes.url" /> URL Visit</label
      >
      <label class="checkbox-label"
      ...
      >
      <label class="checkbox-label"
        ><input type="checkbox" v-model="cfg.modes.schedule" /> Scheduled</label
      >
    </div>
  </div>

  <div v-if="cfg.modes.url" class="form-section">
    <div class="section-title">URL Match Rules</div>
    ...
    <button class="btn-sm" @click="urlRules.push({ kind: 'url', value: '' })">+ Add Rule</button>
  </div>
  ...
  <div v-if="cfg.modes.command" class="form-section">
    ...
    <div class="text-xs text-slate-500" style="padding: 0 20px"
      >Note: Chrome extension shortcuts must be declared in the manifest and cannot be added
