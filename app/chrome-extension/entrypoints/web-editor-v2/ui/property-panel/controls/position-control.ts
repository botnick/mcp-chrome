...
function createPositionIcon(position: PositionValue): SVGElement {
  ...
  switch (position) {
    ...
    case 'relative': {
      // Dashed outline for original position, solid block for offset position
    ...
    case 'fixed': {
      // Pin shape representing fixed positioning
...
function createFlipXIcon(): SVGElement {
  ...
  // Left mirror block (semi-transparent for original)
  ...
  // Right mirror block (solid for flipped)
...
function createFlipYIcon(): SVGElement {
  ...
  // Top mirror block (semi-transparent for original)
  ...
  // Bottom mirror block (solid for flipped)
