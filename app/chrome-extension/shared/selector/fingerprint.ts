/**
 * Element Fingerprint - Fingerprint generation and verification
 *
 * Fingerprints are used for fuzzy element matching and verification, especially for:
 * - Verifying the matched element is the expected one after selector resolution
 * - Element recovery after HMR
 * - Preventing false matches where the same selector resolves to a different element
 */
 ...
 *
 * @returns Similarity score 0-1, where 1 means exact match
 *
 * @example
 * ```ts
 ...
 *
 * Based on similarity threshold, default 0.7
 */
